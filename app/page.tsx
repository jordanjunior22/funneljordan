  ...
  return (
    <div className="bg-[#050806] text-[#f0fdf4] font-sans selection:bg-[#00C853] selection:text-white overflow-x-hidden text-sm md:text-base">
      ...
      <nav className="fixed top-0 inset-x-0 z-[100] flex justify-between items-center px-6 md:px-12 py-5 bg-[#050806]/60 backdrop-blur-md border-b border-white/5">
        ...
        <a href={whatsappLink} className="bg-[#25D366] hover:bg-[#1eb957] text-white px-4 md:px-6 py-2.5 rounded-full text-xs md:text-sm font-bold transition-all shadow-lg shadow-[#25D366]/20 shrink-0">
      ...
      <section className="relative pt-40 pb-24 px-6 text-center max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6">
          <a href={whatsappLink} className="group relative bg-[#f0fdf4] text-[#050806] px-12 py-6 rounded-2xl font-black text-xl overflow-hidden transition-all hover:scale-[1.02]">
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto bg-gradient-to-br from-[#00C853] to-[#007a33] rounded-[40px] p-12 text-center shadow-[0_40px_100px_rgba(0,200,83,0.2)]">
          ...
          <a href={whatsappLink} className="inline-block bg-white text-[#007a33] px-12 py-5 rounded-2xl font-black text-xl hover:bg-[#f0fdf4] transition-all shadow-xl uppercase">
